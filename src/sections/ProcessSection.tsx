...
export default function ProcessSection() {
  ...
  return (
    <section ref={sectionRef} className="section-pinned bg-dark z-30">
      {/* Micro label */}
      ...
      >
        ...
        >
          From paper to physical in days—not months.
        </p>
      </div>
      ...
      >
        <img
          src="/process_laptop_cad.jpg"
          alt="CAD design on laptop"
          className="w-full h-full object-cover"
        />
      </div>
      ...
      >
        <img
          src="/process_hands_assembly.jpg"
          alt="Hands assembling device"
          className="w-full h-full object-cover"
        />
      </div>
    </section>
